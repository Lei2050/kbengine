...
NETWORK_INTERFACE_DECLARE_BEGIN(DbmgrInterface)
	...
	// 收到远程调用转发请求 - lei
	DBMGR_MESSAGE_DECLARE_STREAM(remoteCalWithCallback,				NETWORK_VARIABLE_MESSAGE)

	// 收到远程调用请求 - lei
	DBMGR_MESSAGE_DECLARE_STREAM(onRemoteCalWithCallback,			NETWORK_VARIABLE_MESSAGE)
										
	// 收到远程调用回调转发请求 - lei
	DBMGR_MESSAGE_DECLARE_STREAM(remoteCalWithCallbackCB,			NETWORK_VARIABLE_MESSAGE)

	// 收到远程调用回调请求 - lei
	DBMGR_MESSAGE_DECLARE_STREAM(onRemoteCalWithCallbackCB,			NETWORK_VARIABLE_MESSAGE)
