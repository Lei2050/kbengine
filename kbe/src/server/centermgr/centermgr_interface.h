...
// 收到远程调用请求 - lei
CENTERMGR_MESSAGE_DECLARE_STREAM(remoteCalWithCallback, NETWORK_VARIABLE_MESSAGE)

// 收到远程调用回调请求 - lei
CENTERMGR_MESSAGE_DECLARE_STREAM(remoteCalWithCallbackCB, NETWORK_VARIABLE_MESSAGE)
